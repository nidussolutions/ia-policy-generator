            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3">
                    <button
                        ...
                        className="px-4 bg-light-accent-purple dark:bg-[#8C0368] text-white rounded-md text-sm font-medium hover:opacity-90 transition"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        className="px-4 py-2 text-center border border-light-border  dark:border-dark-text-secondary dark:text-dark-text-primary rounded-md text-sm font-medium hover:bg-light-background dark:hover:bg-dark-card transition"
                    >
