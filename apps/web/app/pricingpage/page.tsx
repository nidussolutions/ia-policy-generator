...
export default function PricingPage() {
  ...
  return (
    <Layout>
      <main className="flex flex-col text-gray-200">
        <motion.section
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              variants={itemVariants}
            >
              <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-[#A429A6] text-white text-xs font-bold py-1 px-4 rounded-full">
                Best Value
              </div>
            ...
            >
              ...
              <p className="text-lg font-bold mb-4 text-[#471ED9]">
                $5 / month
              </p>
              <ul className="space-y-2 text-gray-300 mb-6">
                <li>Unlimited documents</li>
