...
export default function CancellationPage() {
  ...
  return (
    <Layout>
      <main className=" text-gray-200 flex items-center justify-center p-6">
        <motion.div
        ...
        >
          ...
          >
            We will miss you! But don’t worry, you can resubscribe anytime. Your
            data and documents are safe with us.
          </motion.p>
