...
export default function ContactPage() {
    ...
    return (
        <main>
            ...
            <div
                className="min-h-screen bg-gradient-to-b from-[#030526] via-[#1E0359] to-[#030526] py-16 px-4 text-white">
                <motion.div
                ...
                >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-300">Telefone</label>
                            <input
                                type="tel"
                                name="phone"
                                value={form.phone}
                        ...
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-300">Assunto</label>
                            <input
                                type="text"
                                name="subject"
                                value={form.subject}
                        ...
                        <div>
                            <label className="block mb-2 text-sm font-medium text-gray-300">Mensagem</label>
                            <textarea
                                name="message"
                                value={form.message}
                                onChange={handleChange}
